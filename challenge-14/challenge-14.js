...
(function(){
    ...
    */
    ...
    let operation = justMod2Or3.reduce(function(acumulado,atual,index,array){
        return acumulado = (acumulado+1) * atual;
    },0)
    ...
    */
    ...
    // ?
    let existe = numberObjects.some(function(item,index){
        return item.numer === 2;
    })
    console.log(existe);
    let msg = existe?'Existe um objeto { number: 2 } em numberObjects!':
    'Não existe um objeto { number: 2 } em numberObjects :';
    console.log(numberObjects[2].numer);
    let arr = ['Banana','Feijão','Arroz'];
    existe = arr.indexOf('Feijão');
   // existe = numberObjects.indexOf();
    console.log(existe)
    /*
   ...
   let teste = ['Tar','Ci','Sio'];
   var verificaTeste = teste.reduce(function (acumulado,atual){
       console.log(acumulado);
       console.log(atual);
       return ( acumulado +'P'+ atual);
   })
   console.log(verificaTeste);
})()
