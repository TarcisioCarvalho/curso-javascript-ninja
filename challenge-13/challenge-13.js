...
(function(){
    ...
    */
    // ?
    const nordeste = ['Alagoas','Bahia','Ceara','Maranhao','Paraiba','Pernambuco','Piaui','Rio Grande do Norte'];
    /*
    ...
    */
    ...
    // ?
    let seteLetras = brasil.every(function(item){
    ...
    */
    ...
    let msg = !!ceara?'Ceará está incluído!':'Ceará não foi incluído';
    console.log(msg);
    /*
